...
export const FESTIVALS_2026: Omit<FestivalInfo, 'tamilMonth' | 'tamilDay'>[] = [
  { id: 'f1', name: 'New Year', tamilName: 'ஆங்கில புத்தாண்டு', date: '2026-01-01', type: 'national', description: 'புதிய ஆங்கில ஆண்டின் தொடக்கம்' },
  { id: 'f2', name: 'Bhogi Festival', tamilName: 'போகிப் பண்டிகை', date: '2026-01-14', type: 'hindu', description: 'பழையன கழிதலும் புதியன புகுதலும் கொண்டாடும் திருநாள்' },
  { id: 'f3', name: 'Thai Pongal', tamilName: 'தைப்பொங்கல்', date: '2026-01-15', type: 'hindu', description: 'சூரிய பகவானுக்கு நன்றி செலுத்தும் தமிழர்களின் அறுவடைத் திருநாள்' },
  { id: 'f4', name: 'Mattu Pongal / Thiruvalluvar Day', tamilName: 'மாட்டுப் பொங்கல் / திருவள்ளுவர் தினம்', date: '2026-01-16', type: 'hindu', description: 'கால்நடைகளை போற்றி வணங்கும் மாட்டுப் பொங்கல் மற்றும் திருவள்ளுவர் தினம்' },
  { id: 'f5', name: 'Kaanum Pongal', tamilName: 'காணும் பொங்கல்', date: '2026-01-17', type: 'hindu', description: 'உறவினர்களையும் நண்பர்களையும் கண்டு மகிழும் பொங்கல் திருநாளின் இறுதி நாள்' },
  { id: 'f6', name: 'Republic Day', tamilName: 'குடியரசு தினம்', date: '2026-01-26', type: 'national', description: 'இந்திய அரசியலமைப்பு சட்டம் நடைமுறைக்கு வந்த தினம்' },
  { id: 'f7', name: 'Thaipusam', tamilName: 'தைப்பூசம்', date: '2026-02-01', type: 'hindu', description: 'முருகப் பெருமானுக்கு உகந்த தை மாத பௌர்ணமி திருநாள்' },
  { id: 'f8', name: 'Maha Shivaratri', tamilName: 'மகா சிவராத்திரி', date: '2026-02-15', type: 'hindu', description: 'சிவபெருமானை வழிபடும் மிக உன்னதமான இரவு விரத நாள்' },
  { id: 'f11', name: 'Tamil New Year / Chithirai Kani', tamilName: 'தமிழ்ப் புத்தாண்டு (பராபவ வருடம்)', date: '2026-04-14', type: 'hindu', description: 'மங்களகரமான தமிழ்ப் புத்தாண்டு தொடக்கம்' },
  { id: 'f12', name: 'May Day / Labor Day', tamilName: 'உழைப்பாளர் தினம்', date: '2026-05-01', type: 'national', description: 'தொழிலாளர்களின் உழைப்பைப் போற்றும் சர்வதேச மே தினம்' },
  { id: 'f15', name: 'Independence Day', tamilName: 'சுதந்திர தினம்', date: '2026-08-15', type: 'national', description: 'இந்திய திருநாட்டின் சுதந்திர தின விழா' },
  { id: 'f16', name: 'Krishna Jayanthi', tamilName: 'கிருஷ்ண ஜெயந்தி', date: '2026-09-04', type: 'hindu', description: 'ஸ்ரீ கிருஷ்ணர் அவதரித்த உன்னத திருநாள்' },
  { id: 'f17', name: 'Vinayagar Chaturthi', tamilName: 'விநாயகர் சதுர்த்தி', date: '2026-09-15', type: 'hindu', description: 'விநாயகப் பெருமானின் திரு அவதார நாள் விழா' },
  { id: 'f19', name: 'Gandhi Jayanthi', tamilName: 'காந்தி ஜெயந்தி', date: '2026-10-02', type: 'national', description: 'தேசப்பிதா மகாத்மா காந்தியின் பிறந்த நாள் விழா' },
  { id: 'f20', name: 'Ayutha Pooja', tamilName: 'ஆயுத பூஜை', date: '2026-10-19', type: 'hindu', description: 'தொழில் கருவிகளையும் கல்வி நூல்களையும் போற்றி வழிபடும் திருநாள்' },
  { id: 'f21', name: 'Vijayadhasami', tamilName: 'விஜயதசமி', date: '2026-10-20', type: 'hindu', description: 'தீமைகளை வென்று நன்மைகள் பெருகும் நாள் மற்றும் நற்கல்வி தொடக்கம்' },
  { id: 'f22', name: 'Deepavali', tamilName: 'தீபாவளி', date: '2026-11-08', type: 'hindu', description: 'தீப ஒளி ஏற்றி மகிழ்ச்சியாகக் கொண்டாடும் நன்னாள்' },
  { id: 'f23', name: 'Karthigai Deepam', tamilName: 'கார்த்திகை தீபம்', date: '2026-11-23', type: 'hindu', description: 'கார்த்திகை மாத பௌர்ணமி விளக்குத் திருவிழா' },
];
